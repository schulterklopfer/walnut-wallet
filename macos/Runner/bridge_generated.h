...
void wire_leave_federation(int64_t port_, struct wire_uint_8_list *label);

void wire_balance(int64_t port_, struct wire_uint_8_list *label);

void wire_pay(int64_t port_, struct wire_uint_8_list *label, struct wire_uint_8_list *bolt11);

void wire_invoice(int64_t port_,
                  struct wire_uint_8_list *label,
                  uint64_t amount,
                  struct wire_uint_8_list *description);

void wire_fetch_payment(int64_t port_,
                        struct wire_uint_8_list *label,
                        struct wire_uint_8_list *payment_hash);

void wire_list_payments(int64_t port_, struct wire_uint_8_list *label);

void wire_configured_status(int64_t port_, struct wire_uint_8_list *label);

void wire_connection_status(int64_t port_, struct wire_uint_8_list *label);

void wire_network(int64_t port_, struct wire_uint_8_list *label);
...
void wire_decode_invoice(int64_t port_,
                         struct wire_uint_8_list *label,
